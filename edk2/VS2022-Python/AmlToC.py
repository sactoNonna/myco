...
###################################################################
# From C:\myco\edk2\BaseTools\BinWrappers\WindowsLike\AmlToC.bat:
#   @setlocal
#   @set ToolName=%~n0%
#   @%PYTHON_COMMAND% %BASE_TOOLS_PATH%\Source\Python\%ToolName%\%ToolName%.py %*
# Note: The following was added to replace the above AmlToC.bat file contents:
syspathMore = ['C:\\myco\\edk2\\BaseTools\\Source\\Python', 'C:\\myco\\edk2\\BaseTools\\Source\\Python\\build']
sys.path.extend(syspathMore)
###################################################################
import argparse
